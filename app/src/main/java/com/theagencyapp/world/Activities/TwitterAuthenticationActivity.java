...
public class TwitterAuthenticationActivity extends AppCompatActivity {
    ...
    {
        EditText f=(EditText)findViewById(R.id.pin);
        String k=f.getText().toString();
        //urlpp="https://api.twitter.com/oauth/authorize?oauth_token="+k;
        //mWebView.loadUrl(urlpp);
        Intent resultIntent = new Intent();
        resultIntent.putExtra("pin", k);
        setResult(RESULT_OK, resultIntent);
        finish();
    }
}
